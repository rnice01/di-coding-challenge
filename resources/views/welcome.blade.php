    ...
    <section id="contact" class="container content-section text-center">
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p class="bg-primary">
					<form method="post" action="/contact-guy">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="email-field">Email*</label>
                            <input id="email-field" class="form-control" type="email" name="email" placeholder="Your email here" required />
                        </div>
                        <div class="form-group">
                            <label for="full-name-field">Full Name*</label>
                            <input id="full-name-field" class="form-control" type="text" name="full_name" placeholder="Your name" required />
                        </div>
                        <div class="form-group">
                            <label for="phone-field">Phone</label>
                            <input id="phone-field" class="form-control" type="text" name="phone" />
                        </div>
                        <div class="form-group">
                            <label for="message-field">Message*</label>
                            <textarea id="message-field" class="form-control" name="message" placeholder="Say something to guy!" required></textarea>
                        </div>
